  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-start z-10 p-0 mb-10">
        <img
          src="/main.jpg"
          className="w-full h-screen object-cover rounded-b-lg shadow-lg"
          alt="Home Page image"
        />
      </div>
        ...
        <div className="text-center z-10 relative px-6">
          <h1 className="text-red-600 text-4xl font-bold mb-4">About the Foundation</h1>
          <p className="text-black text-2xl mx-auto max-w-3xl mb-8 px-4 leading-relaxed text-justify">
        ...
        <LeadershipSection />
          ...
          <h1 className="text-red-600 text-4xl font-bold mb-14 mt-14">Our Campus Teams</h1>
          {/* NUST Islamabad Team */}
          <h2 className="text-black text-2xl font-bold mt-24 mb-10 text-center">NUST Islamabad Team</h2>
          <div className=" mb-10">
            <Carousel images={images} />
          </div>
          {/* CMH Lahore Team */}
          <h2 className="text-black text-2xl font-bold mt-24 mb-10 text-center">CMH Lahore Team</h2>
