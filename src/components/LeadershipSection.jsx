...
const LeadershipSection = () => {
  return (
    <section className="bg-gray-100 py-12 px-4 md:px-6">
      <h1 className="text-red-600 text-3xl md:text-5xl font-extrabold text-center mb-12 md:mb-16">Our Leadership</h1>

      {/* Rayan Malik */}
      <div className="flex flex-wrap items-start mb-12 md:mb-16 px-4 bg-white shadow-md rounded-lg transition-shadow duration-300 hover:shadow-xl">
        <div className="flex justify-center w-full md:w-1/3 p-4 text-center">
          <img
            src="/rayan.JPG"
            alt="Rayan Malik"
        ...
        <div className="w-full md:w-2/3 p-4 md:p-6 flex flex-col justify-center">
          <h2 className="font-extrabold text-xl md:text-3xl text-gray-800">Founder & CEO</h2>
          <p className="text-lg md:text-2xl text-gray-700">Rayan Malik</p>
          <p className="text-sm md:text-lg mt-4 md:mt-6 leading-relaxed text-justify text-gray-600">
      ...
      <div className="flex flex-wrap items-start mb-12 md:mb-16 px-4 bg-white shadow-md rounded-lg transition-shadow duration-300 hover:shadow-xl">
        ...
        <div className="w-full md:w-2/3 p-4 md:p-6 flex flex-col justify-center">
          <h2 className="font-extrabold text-xl md:text-3xl text-gray-800">Co-founder & COO</h2>
          <p className="text-lg md:text-2xl text-gray-700">Khuzaima Qureshi</p>
          <p className="text-sm md:text-lg mt-4 md:mt-6 leading-relaxed text-justify text-gray-600">
      ...
      <div className="flex flex-wrap items-start mb-12 md:mb-16 px-4 bg-white shadow-md rounded-lg transition-shadow duration-300 hover:shadow-xl">
        ...
        <div className="w-full md:w-2/3 p-4 md:p-6 flex flex-col justify-center">
          <h2 className="font-extrabold text-xl md:text-3xl text-gray-800">Manager Campus Teams</h2>
          <p className="text-lg md:text-2xl text-gray-700">Asadullah Ashraf</p>
          <p className="text-sm md:text-lg mt-4 md:mt-6 leading-relaxed text-justify text-gray-600">
      ...
      <div className="flex flex-wrap items-start mb-12 md:mb-16 px-4 bg-white shadow-md rounded-lg transition-shadow duration-300 hover:shadow-xl">
        ...
        <div className="w-full md:w-2/3 p-4 md:p-6 flex flex-col justify-center">
          <h2 className="font-extrabold text-xl md:text-3xl text-gray-800">Content Head</h2>
          <p className="text-lg md:text-2xl text-gray-700">Muhammad Khuzaima</p>
        </div>
      </div>
    </section>
  );
